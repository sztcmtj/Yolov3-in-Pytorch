...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='detect over video')
    parser.add_argument("-c", "--cls_conf", help="whether use class confidence", action="store_true")
    parser.add_argument('-f','--file_path', help='video url to detect', type=str)
    ...
    detect_video(conf, args.file_path, args.output_path, yolo, args.level)